        ...
        return {
            ...
            'tones': {
                "Friendly": {
                    ...
                    "icon": resource_path(os.path.join('src', 'ui', 'static', 'material_icons_round', 'social','round_emoji_emotions_black_48dp_white.png'))
                },
                "Professional": {
                    ...
                    "icon": resource_path(os.path.join('src', 'ui', 'static', 'material_icons_round', 'places','round_business_center_black_48dp_white.png'))
                },
                "Polite": {
                    ...
                    "icon": resource_path(os.path.join('src', 'ui', 'static', 'material_icons_round', 'maps','round_local_florist_black_48dp_white.png'))
                },
                "Casual": {
                    ...
                    "icon": resource_path(os.path.join('src', 'ui', 'static', 'material_icons_round', 'maps','round_local_cafe_black_48dp_white.png'))
                },
                "Concise": {
                    ...
                    "icon": resource_path(os.path.join('src', 'ui', 'static', 'material_icons_round', 'editor','round_vertical_align_center_black_48dp_white.png'))
                }
            },
            'formats': {
                "Summary": {
                    "prompt": "Summarize the text. Capture the main points succinctly without adding new information or assuming anything.",
                    "icon": resource_path(os.path.join('src', 'ui', 'static', 'material_icons_round', 'content','round_sort_black_48dp_white.png'))
                },
                "Keypoints": {
                    ...
                    "icon": resource_path(os.path.join('src', 'ui', 'static', 'material_icons_round', 'editor','round_format_list_bulleted_black_48dp_white.png'))
                },
                "List": {
                    ...
                    "icon": resource_path(os.path.join('src', 'ui', 'static', 'material_icons_round', 'editor','round_format_list_numbered_black_48dp_white.png'))
                },
                "Markdown": {
                    ...
                    "icon": resource_path(os.path.join('src', 'ui', 'static', 'material_icons_round', 'editor','round_table_chart_black_48dp_white.png'))
                }
            }
        }
